...
const Repairs: React.FC = () => {
  ...
  const handleDeleteConfirm = () => {
    if (repairToDelete !== null) {
      setRepairs(repairs.filter((r) => r.id !== repairToDelete));
  ...
  return (
    <Container>
              ...
              .map((repair) => (
                <TableRow key={repair.id}>
                  ...
                  <TableCell>
                    ...
                    <IconButton color="error" onClick={() => handleDeleteClick(repair.id)}>
                      <DeleteIcon />
                    </IconButton>
                  </TableCell>
                </TableRow>
      ...
      <Dialog open={deleteDialogOpen} onClose={handleDeleteCancel}>
        <DialogTitle>Xác Nhận Xóa Sửa Chữa</DialogTitle>
        <DialogContent>
          <Typography variant="body1">
            Bạn có chắc chắn muốn xóa sửa chữa "Căn hộ {repairs.find((r) => r.id === repairToDelete)?.apartment}"?
